...
def test_filter_by_state(dictionaries: list[dict], dict_no_state_data: list[dict], dict_one_state_data: list[dict]) -> None:
    ...
    assert filter_by_state(dict_one_state_data) == [{"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"}]


def test_sort_by_date(dictionaries: list[dict], dict_no_state_data: list[dict], dict_one_state_data: list[dict]) -> None:
